...
/**
 * A message signaling that all mutations are complete.
 * 
 * @author torben
 * 
 */
public class MutateSequenceFinishedMsg {

	public final ObjectId projectId;
	public final long totalMutationsGenerated;

	public MutateSequenceFinishedMsg(ObjectId projectId, long total) {
		super();
